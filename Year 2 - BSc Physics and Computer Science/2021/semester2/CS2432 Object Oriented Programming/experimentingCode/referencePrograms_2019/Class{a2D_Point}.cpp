...
int main()
{
	...
	//	Now, display the values of the three points on the screen, susing the overloaded operator "<<"
	...
	if (P1 != P2)
		std::cout << P1 << " != " << P2 << "\n";
	// Return the x-y coordinate for a point
	std::cout << "The xy coordinates for P2: " <<  "("<< *P2.get_xyCoord() <<", " << *(P2.get_xyCoord() + 1)<<")" <<"\n";
