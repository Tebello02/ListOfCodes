...
/* int main()
{
	...
	std::cout << "The Initial Values of P1, P2 and P3 are as follows;\n\n";
	std::cout << "P1 = " << P1 << "\n" << "P2 = " << P2 << "\n" << "P3 = " << P3 << "\n\n";
	/*	
	...
	P1 = new a2D_Point, 		// instantiate P1 as a pointer to a 2D point with values: (0, 0)
	P2 = new a2D_Point(1,2);	// instantiate P2 as a pointer to a 2D point with values: (1, 2)
	P3 = new a2D_Point(3);		// instantiate P3 as a pointer to a 2D point with values: (3, 0)
	...
	//	Now set the coordinates of point *P1 to (3, 4) from (0, 0)
	...
	//	Now get the x and y coordinates of P1, and display them
	double * xy = P1 -> get_xyCoord();
