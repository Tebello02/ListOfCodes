...
class aPoint
{
	private:
		...
		long int dimension;	//	the number of points, i.e. N dimensional space -- 1D is the real line
...
//	The distance of point (x0, x1, x2, ..., xN) from the origin is given by
//
//	sqrt(x0*x0 + x1*x1 + x2*x2 + ... + xN*xN)
{
	// C++ code here
}
...
int main()
{
	aPoint	P1, 		// Declares P1 as a 2D point with values: (0, 0)
