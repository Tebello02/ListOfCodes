...
template <class Type>//Question --27
bool aSet<Type> :: member (Type token,long & Position)
...
template <class Type>//Question --28
...
template <class Type>// question---1
void aSet<Type> ::	remove(Type object, bool & flag)//deletes data and checks if it is indeed deleted.. then flag= true otherwise false
{
	//	C++ Code Here
	long i = 0, slot = 0;
	flag = false;
...
template <class Type> //Question---2
void aSet<Type> :: display(Type dir)
...
template <class Type>//Question---3
...
/*template <class Type>//Question---4
...
template <class Type>//Question---6
aSet<Type> aSet<Type> :: operator += (aSet<Type> right)
{
	//	C++ Code Here
}
...
template <class Type>//question--7
aSet<Type> aSet<Type> :: operator + (Type right)
...
template <class Type>// question 8
aSet<Type> aSet<Type> :: operator += (Type right)
{
	//	C++ Code Here
}
...
template <class Type>//Question---9
...
template <class Type> //Question---10
aSet<Type> aSet<Type> :: operator - (aSet<Type> right)
...
template <class Type>//question---11
aSet<Type> aSet<Type> :: operator -= (aSet<Type> right)
{
	//	C++ Code Here
}
...
template <class Type>//Question----12
aSet<Type> aSet<Type> :: operator - (Type right)
{
	//	C++ Code Here
}
...
template <class Type>//Question---13
aSet<Type> aSet<Type> :: operator -= (Type right)
{
	//	C++ Code Here
}
...
template <class Type>//Question----15
aSet<Type> aSet<Type> :: operator *= (aSet<Type> right)
{
	//	C++ Code Here
}
...
template <class Type>//Question---16
aSet<Type> aSet<Type> :: operator * (Type right)
{
	//	C++ Code Here
}
...
template <class Type>// Question--17
aSet<Type> aSet<Type> :: operator *= (Type right)
{
	//	C++ Code Here
}
...
template <class Type>//Question----18
...
template <class Type>//Question--19
bool aSet<Type> :: operator > (aSet<Type> right)
{
	//	C++ Code Here
}
...
template <class Type>//Question--20
bool aSet<Type> :: operator < (aSet<Type> right)
{
	//	C++ Code Here
}
...
template <class Type>//Question--21
bool aSet<Type> :: operator >= (aSet<Type> right)
{
	//	C++ Code Here
}
...
template <class Type>//Question--22
bool aSet<Type> :: operator <= (aSet<Type> right)
{
	//	C++ Code Here
}
...
template <class Type>//Question--23
bool aSet<Type> :: operator != (aSet<Type> right)
{
	//	C++ Code Here
}
...
template <class Type>//Question--24
...
template <class Type>//Question--25
