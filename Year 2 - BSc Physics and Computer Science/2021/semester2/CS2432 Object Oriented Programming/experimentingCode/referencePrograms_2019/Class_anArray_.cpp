...
template <class Type>
std::ostream & operator << (std::ostream & output, anArray<Type> Array)
...
template <class Type>
anArray<Type> operator + (Type object, anArray<Type> Array)
...
template <class Type>
bool found (Type token, anArray<Type> Array, long & Position)
